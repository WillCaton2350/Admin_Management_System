...
fN = customtkinter.CTkLabel(uIF,text_color="#141414", text="First Name")
fN.grid(row=0, column=0)
lN = customtkinter.CTkLabel(uIF,text_color="#141414", text="Last Name")
...
hL = customtkinter.CTkLabel(uIF,text_color="#141414",text="Title")
hCB = customtkinter.CTkComboBox(uIF,values=["","Mr","Mrs"])
hL.grid(row=0, column=2)
hCB.grid(row=1, column=2)

ageL = customtkinter.CTkLabel(uIF,text_color="#141414", text="Age")
...
nCB = customtkinter.CTkComboBox(uIF,values=["","American","African-American","Caribbean-American","Hispanic","Chinese,Indian"])
...
rCheck = customtkinter.CTkCheckBox(courseF,text_color="#141414", text="currently registered",variable=cVar,onvalue="Registered",offvalue="Unregistered")
regL.grid(row=0, column=0)
rCheck.grid(row=1, column=0)

numCo = customtkinter.CTkLabel(courseF,text_color="#141414", text="Number of courses completed")
numCSpin = tkinter.Spinbox(courseF, from_=0, to='infinity')
numCo.grid(row=0, column=1)
numCSpin.grid(row=1, column=1)

numSem = customtkinter.CTkLabel(courseF,text_color="#141414", text="Number of semesters completed")
...
termsCheck = customtkinter.CTkCheckBox(terms,text_color="#141414",text=" I accept the Terms & Conditions", variable=agreed,onvalue="Agreed",offvalue="N/A")
